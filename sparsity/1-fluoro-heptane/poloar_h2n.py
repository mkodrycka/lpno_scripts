...
for cut in cutoffs:
    ...
    optrot_lg = ccsd_lpno.do_linresp(wfn, omega_nm, mol, method='polar', gauge='length', localize=localize, pert=None)
    #optrot_lg = ccsd_lpno.do_linresp(wfn, omega_nm, mol, method='polar', gauge='length', localize=False, pert=None)
    #optrot_lg = ccsd_lpno.do_linresp(wfn, omega_nm, mol, method='polar', gauge='length', localize=False, pert=pert)
